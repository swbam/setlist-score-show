          ...
          <div>
            <div className="mb-4 flex justify-between items-center">
              ...
              <button
                onClick={handleImportFromSpotify}
                disabled={isImporting}
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#1DB954] text-white rounded-lg text-sm font-medium hover:bg-[#1aa34a] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
